...
/** Un exemple de document html qui correspond au code HTML suivant: <html>
  * <head> <meta charset="utf-8" /> <title>My Page</title> </head> <body>
  * <center> <a href="http://www.irisa.fr">Lien</a> </center> </body> </html>
  */
          ...
          Tag(
            ...
            List(
              Tag(
                "a",
                List(
                  ("href", "http://www.irisa.fr/123456"),
                  ("href", "http://www.irisa.fr/12345c6"),
                  ("href", "")
                ),
                List(Texte("Lien"))
              )
